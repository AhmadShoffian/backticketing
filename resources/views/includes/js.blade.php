  ...
  <!-- JS Libraies -->
  <script src="{{ asset('back/modules/simple-weather/jquery.simpleWeather.min.js') }}"></script>
  <script src="{{ asset('back/modules/chart.min.js') }}"></script>
  <script src="{{ asset('back/modules/jqvmap/dist/jquery.vmap.min.js') }}"></script>
  <script src="{{ asset('back/modules/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
